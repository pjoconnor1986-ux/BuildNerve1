...
export default function Home(){
 ...
 return <div className="shell">
  ...
  <main>
   ...
   {view==='procurement'&&<section><Card title="Procurement" sub="Buy from forecast demand, not panic"><Table headers={["Item","Project","On hand","7-day need","ETA","Risk"]} rows={[["150mm drainage pipe","Oakfield","24m","96m","Tomorrow 10:00",<Pill key="1" v="Red"/>],["C25/30 concrete","Oakfield","0","18m³","Not booked",<Pill key="2" v="Amber"/>],["6F2","Riverside","420t","650t","2 days",<Pill key="3" v="Amber"/>],["Type 1","Oakfield","320t","280t","Available",<Pill key="4" v="Green"/>]]}/><button className="wide" onClick={()=>openAgent('Build the 7-day procurement action plan and prioritise by programme impact')}>✦ Build buying plan</button></Card></section>}
